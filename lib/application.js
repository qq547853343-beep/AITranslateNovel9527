...
export async function createApplication({ baseDirectory, dataDirectory: suppliedDataDirectory, databaseFile, fetchImpl = fetch, secretStore: suppliedSecretStore, launcherControl = {} } = {}) {
